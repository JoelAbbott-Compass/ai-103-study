  ...
  "guides": [
    {
      ...
      "sections": [
        ...
        },
        {
          ...
          "label": "Verify & gaps",
          "title": "VERIFY / GAPS",
          "html": "\n<ul>\n<li>Nothing unverified — all facts here are well-established Azure fundamentals.</li>\n<li><strong>Coverage:</strong> objective <strong>1.5</strong> is now <em>partial</em>. Still uncovered for 1.5: private networking topology and the <em>Foundry-specific</em> deployment/infra design (comes later, lectures 28–34). Tracked in <code>output/coverage_map.md</code>.</li>\n</ul>\n      "
        }
      ],
